...
data = spark.read.format("csv").option("header", True).option("inferSchema", True).option("delimiter", ",").load("C:\\Users\\Kruthika\\PycharmProjects\\BDP_ICP7\\diabetic_data.csv")
